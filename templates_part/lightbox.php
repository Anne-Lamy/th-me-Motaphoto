...
<div id="lightbox" class="lightbox">
    ...
    <button class="lightbox_prev" alt="Précédente" data-image="<?php echo esc_attr($prev_image_url); ?>"> </button>
    <?php endif; ?>

    <?php if ($next_image_url) : ?>
    <button class="lightbox_next" alt="Suivante" data-image="<?php echo esc_attr($next_image_url); ?>"> </button>
    <?php endif; ?> 
